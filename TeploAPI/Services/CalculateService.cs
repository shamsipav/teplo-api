...
namespace TeploAPI.Services
{
    ...
    {
        public Result СalculateThermalRegime(Furnace input)
        {
        ...
        // TODO: Refactoring.
        public ProjectDataViewModel CalculateProjectThermalRegime(Furnace input, FurnaceProject project, Reference reference)
        {
