...
public interface IBasePeriodService
{
    ...
    /// </summary>
    Task<ResultViewModel> ProcessBasePeriod(FurnaceBaseParam furnaceBase, bool saveData);
    ...
    Task<UnionResultViewModel> ProcessComparativePeriod(Guid basePeriodId, Guid comparativePeriodId);
}